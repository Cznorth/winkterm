...
const translations = {
  ...
  "settings.navAiSetup": { zh: "AI 接入", en: "AI Setup" },
  "settings.navModels": { zh: "模型", en: "Models" },
  "settings.navAgentBehavior": { zh: "Agent 行为", en: "Agent Behavior" },
  "settings.navSecurity": { zh: "访问与安全", en: "Access & Security" },
  "settings.navAppearance": { zh: "外观", en: "Appearance" },
  "settings.navAbout": { zh: "关于与更新", en: "About & Updates" },
  "settings.providerCodex": { zh: "Codex 账号", en: "Codex Account" },
  "settings.providerOpenAI": { zh: "OpenAI 兼容", en: "OpenAI Compatible" },
  "settings.providerAnthropic": { zh: "Anthropic", en: "Anthropic" },
  "settings.providerRecommended": { zh: "推荐", en: "Recommended" },
  "settings.providerAdvanced": { zh: "高级", en: "Advanced" },
  "settings.aiStatusTitle": { zh: "连接状态", en: "Connection status" },
  "settings.aiStatusNotConfigured": { zh: "尚未配置 AI 提供方", en: "AI provider not configured" },
  "settings.aiStatusNeedsAuth": { zh: "需要登录或填写 API Key", en: "Login or API key required" },
  "settings.aiStatusTesting": { zh: "正在测试连接…", en: "Testing connection…" },
  "settings.aiStatusReady": { zh: "提供方可用", en: "Provider ready" },
  "settings.aiStatusError": { zh: "连接异常", en: "Connection error" },
  ...
  "settings.editDoc": { zh: "编辑", en: "Edit" },
  "settings.closeEditor": { zh: "返回列表", en: "Back to list" },
  ...
  "settings.revealToken": { zh: "复制完整 Token", en: "Copy full token" },
  "settings.editToken": { zh: "手动编辑", en: "Edit manually" },
  "settings.doneEditingToken": { zh: "完成编辑", en: "Done editing" },
  ...
  "settings.fetchModelsGoModels": { zh: "获取模型", en: "Fetch models" },
  "settings.goToModelsSection": { zh: "前往模型分区", en: "Go to Models" },
  ...
  "settings.codexCopyAuthUrl": { zh: "复制授权链接", en: "Copy authorization link" },
  ...
  "settings.candidateModels": { zh: "候选模型", en: "Candidate Models" },
  "settings.selectAllModels": { zh: "全选", en: "Select all" },
  "settings.unselectAllModels": { zh: "全不选", en: "Unselect all" },
  "settings.testSelectedModels": { zh: "测试勾选", en: "Test selected" },
  "settings.addAvailableModels": { zh: "添加可用", en: "Add available" },
  "settings.addSelectedModels": { zh: "添加勾选", en: "Add selected" },
  "settings.testModel": { zh: "测试", en: "Test" },
  "settings.clearModels": { zh: "清空已配置模型", en: "Clear configured models" },
  "settings.modelStatusUnknown": { zh: "未测", en: "Untested" },
  "settings.modelStatusTesting": { zh: "测试中", en: "Testing" },
  "settings.modelStatusOk": { zh: "可用", en: "OK" },
  "settings.modelStatusFailed": { zh: "失败", en: "Failed" },
